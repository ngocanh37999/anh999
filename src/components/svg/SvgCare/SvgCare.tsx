import * as S from './svgCare.style'
export default function SvgCare() {
  return (
    <S.SvgCare>
      <svg
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g fillRule="nonzero">
            ...
            <g transform="translate(.005 -.004)">
              ...
              <use fill="url(#f)" xlinkHref="#a" />{' '}
              <use fill="url(#g)" xlinkHref="#a" />{' '}
              <use fill="url(#h)" xlinkHref="#a" />{' '}
            </g>{' '}
            <path
          ...
          <g fillRule="nonzero">
            ...
            <use fill="url(#q)" xlinkHref="#n" />{' '}
            <use fill="url(#r)" xlinkHref="#n" />{' '}
            <use fill="url(#s)" xlinkHref="#n" />{' '}
            <use fill="url(#t)" xlinkHref="#n" />{' '}
            <use fill="url(#u)" xlinkHref="#n" />{' '}
            <use fillOpacity=".5" fill="url(#v)" xlinkHref="#n" />{' '}
          </g>{' '}
