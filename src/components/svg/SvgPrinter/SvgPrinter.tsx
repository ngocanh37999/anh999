...
import * as S from './svgPrinter.style'

export default function SvgPrinter() {
  return (
    <S.SvgPrinter>
      <svg
        version="1.1"
        ...
        y="0px"
        viewBox="0 0 463 463"
        style={{ enableBackground: 'new 0 0 463 463' } as CSSProperties}
        xmlSpace="preserve"
      >
        <g>
          <g>
            <g>
              <path
                d="M423.5,144H383v-0.5c0-17.369-14.131-31.5-31.5-31.5H351V39.5c0-4.142-3.357-7.5-7.5-7.5h-224
              ...
              />
              <path
                d="M103.5,239c12.958,0,23.5-10.542,23.5-23.5S116.458,192,103.5,192S80,202.542,80,215.5S90.542,239,103.5,239z M103.5,207
				c4.687,0,8.5,3.813,8.5,8.5s-3.813,8.5-8.5,8.5s-8.5-3.813-8.5-8.5S98.813,207,103.5,207z"
              />
              <path
                d="M151.5,223h16c4.143,0,7.5-3.358,7.5-7.5c0-4.142-3.357-7.5-7.5-7.5h-16c-4.143,0-7.5,3.358-7.5,7.5
				C144,219.642,147.357,223,151.5,223z"
              />
              <path
                d="M199.5,223h16c4.143,0,7.5-3.358,7.5-7.5c0-4.142-3.357-7.5-7.5-7.5h-16c-4.143,0-7.5,3.358-7.5,7.5
				C192,219.642,195.357,223,199.5,223z"
              />
              <path
                d="M311.5,320h-160c-4.143,0-7.5,3.358-7.5,7.5c0,4.142,3.357,7.5,7.5,7.5h160c4.143,0,7.5-3.358,7.5-7.5
				C319,323.358,315.643,320,311.5,320z"
              />
              <path
                d="M311.5,352h-160c-4.143,0-7.5,3.358-7.5,7.5c0,4.142,3.357,7.5,7.5,7.5h160c4.143,0,7.5-3.358,7.5-7.5
